...
#if !TARGET_OS_TV
static const char *accelerometerName = "iOS Accelerometer No Gravity";
...
IOS_AccelerometerUpdate(SDL_Joystick * joystick)
{
    ...
    @autoreleasepool {
        ...
        //Switched to a static variable:
        //accel = motionManager.deviceMotion.userAcceleration;
    }
