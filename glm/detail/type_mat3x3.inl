...
#		endif
	...
	template<typename T, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<3, 3, T, Q>::mat(T const& a, T const& b, T const& c)
#		if GLM_HAS_INITIALIZER_LISTS
		: value{
			col_type(0, c,  -b),
			col_type(-c,  0, a),
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
		this->value[0] = col_type(0, c, -b);
		this->value[1] = col_type(-c, 0, a);
		this->value[2] = col_type(b, -a, 0);
#		endif
	}
