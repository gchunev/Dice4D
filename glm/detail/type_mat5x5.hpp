/// @ref core
/// @file glm/detail/type_mat5x5.hpp

#pragma once

#include "type_vec5.hpp"
#include <limits>
#include <cstddef>
...
namespace glm
{
	...
	struct mat<5, 5, T, Q>
	{
		typedef vec<5, T, Q> col_type;
		typedef vec<5, T, Q> row_type;
		typedef mat<5, 5, T, Q> type;
		typedef mat<5, 5, T, Q> transpose_type;
	...
	public:
		...
		GLM_FUNC_DECL GLM_CONSTEXPR mat(mat<5, 5, T, P> const& m);
		...
		GLM_FUNC_DECL GLM_EXPLICIT GLM_CONSTEXPR mat(mat<5, 5, U, P> const& m);
		...
		template<typename U>
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator=(mat<5, 5, U, Q> const& m);
		template<typename U>
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator+=(U s);
		template<typename U>
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator+=(mat<5, 5, U, Q> const& m);
		template<typename U>
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator-=(U s);
		...
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator++();
		GLM_FUNC_DECL mat<5, 5, T, Q> & operator--();
		GLM_FUNC_DECL mat<5, 5, T, Q> operator++(int);
		GLM_FUNC_DECL mat<5, 5, T, Q> operator--(int);
	};
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<5, 5, T, Q> operator+(mat<5, 5, T, Q> const& m);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<5, 5, T, Q> operator+(mat<5, 5, T, Q> const& m, T const& s);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<5, 5, T, Q> operator+(T const& s, mat<5, 5, T, Q> const& m);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL mat<5, 5, T, Q> operator+(mat<5, 5, T, Q> const& m1, mat<5, 5, T, Q> const& m2);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<5, 5, T, Q>::col_type operator*(mat<5, 5, T, Q> const& m, typename mat<5, 5, T, Q>::row_type const& v);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<4, 4, T, Q>::col_type operator*(mat<5, 5, T, Q> const& m, typename mat<4, 4, T, Q>::row_type const& v);

	template<typename T, qualifier Q>
	GLM_FUNC_DECL typename mat<5, 5, T, Q>::row_type operator*(typename mat<5, 5, T, Q>::col_type const& v, mat<5, 5, T, Q> const& m);
	...
	template<typename T, qualifier Q>
	GLM_FUNC_DECL bool operator==(mat<5, 5, T, Q> const& m1, mat<5, 5, T, Q> const& m2);
