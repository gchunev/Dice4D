...
#		endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, T, Q>::mat
	(
		T const& xy, T const& xz, T const& xw,
		T const& yz, T const& yw, T const& zw
	)
#		if GLM_HAS_INITIALIZER_LISTS
		: value{
		col_type( 0,   xy, -xz,  xw),
...
#		endif
	{
#		if !GLM_HAS_INITIALIZER_LISTS
		this->value[0] = col_type(0, xy, -xz, xw);
		this->value[1] = col_type(-xy, 0, yz, -yw);
		this->value[2] = col_type(xz, -yz, 0, zw);
		this->value[3] = col_type(-xw, yw, -zw, 0);
#		endif
	}
