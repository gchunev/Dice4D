...
namespace detail
{
	...
	/// Return the eigenvalues of a skew-symmetric matrix.
	///
	/// @tparam N Integer between 2 and 4 included that indicates the dimension of the matrix.
	/// @tparam T Floating-point or signed integer scalar types
	/// @tparam Q Value from qualifier enum
	template<length_t N, typename T, qualifier Q>
	GLM_FUNC_DECL vec<N, T, Q> eigenvalues(mat<N, N, T, Q> const& m);

	/// Exponentiate a skew-symmetric matrix using Rodrigues' formula.
	///
	/// @tparam N Integer between 3 and 4 included that indicates the dimension of the matrix.
	/// @tparam T Floating-point or signed integer scalar types
	/// @tparam Q Value from qualifier enum
	template<length_t N, typename T, qualifier Q>
	GLM_FUNC_DECL mat<N, N, T, Q> exponentiate(mat<N, N, T, Q> const& m);
	/// @}
}//namespace glm
